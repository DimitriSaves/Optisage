...
export class AppSage2Component implements OnInit {
    ...
    this.mainMenuItems = [
      {
        ...
        command: (event) => { this.selectMainMenu('Administration'); }
      },
      {
        label: 'Développement',
        command: (event) => { this.selectMainMenu('Développement'); }
      },
      {
        label: 'Paramétrage',
        command: (event) => { this.selectMainMenu('Paramétrage'); }
      },
      {
        label: 'Données de base',
        command: (event) => { this.selectMainMenu('Données de base'); }
      },
      {
        label: 'Relation client',
        command: (event) => { this.selectMainMenu('Relation client'); }
      },
      {
        label: 'Affaires',
        command: (event) => { this.selectMainMenu('Affaires'); }
      },
      {
        label: 'Achats',
        command: (event) => { this.selectMainMenu('Achats'); }
      },
      {
        label: 'Ventes',
        command: (event) => { this.selectMainMenu('Ventes'); }
      },
      {
        label: 'Stocks',
        command: (event) => { this.selectMainMenu('Stocks'); }
      },
      {
        label: 'Production',
        command: (event) => { this.selectMainMenu('Production'); }
      },
      {
        label: 'Gestion des indices',
        command: (event) => { this.selectMainMenu('Gestion des indices'); }
      },
      {
        label: 'Contrôle de gestion',
        command: (event) => { this.selectMainMenu('Contrôle de gestion'); }
      },
      {
        label: 'Comptabilité',
        command: (event) => { this.selectMainMenu('Comptabilité'); }
      },
      {
        label: ' Comptabilité tiers',
        command: (event) => { this.selectMainMenu(' Comptabilité tiers'); }
      },
      {
        label: 'Déclarations',
        command: (event) => { this.selectMainMenu('Déclarations'); }
      },
      {
        label: 'Immobilisations',
        command: (event) => { this.selectMainMenu('Immobilisations'); }
      },
      {
        label: 'Terminaux portables',
        command: (event) => { this.selectMainMenu('Terminaux portables'); }
      },
      {
        label: 'Exploitation',
        command: (event) => { this.selectMainMenu('Exploitation'); }
      },
      {
        label: 'Impressions',
        command: (event) => { this.selectMainMenu('Impressions'); }
      },
      {
        label: 'Traductions',
        command: (event) => { this.selectMainMenu('Traductions'); }
      },
      {
        label: 'Pages en lecture seule',
        command: (event) => { this.selectMainMenu('Pages en lecture seule'); }
      },
      {
        label: 'EDI',
        command: (event) => { this.selectMainMenu('EDI'); }
      },
      {
        label: '4CAD Gestion de la qualité',
        command: (event) => { this.selectMainMenu('4CAD Gestion de la qualité'); }
      },
      {
        label: '4CAD Gestion des moyens',
        command: (event) => { this.selectMainMenu('4CAD Gestion des moyens'); }
      },
      {
        label: '4CAD Gestion des habilitations',
        command: (event) => { this.selectMainMenu('4CAD Gestion des habilitations'); }
      },
      {
        label: '4CAD Devis technique',
        command: (event) => { this.selectMainMenu('4CAD Devis technique'); }
      },
      {
        label: '4CAD Suivi atelier',
        command: (event) => { this.selectMainMenu('4CAD Suivi atelier'); }
      },

      // ... autres éléments de menu principal
    ];

    // Initialisation des éléments pour MegaMenu à vide
    this.megaMenuItems = [];
  }
  ...
  getVerificationSubMenu(): MenuItem[] {
    return [
      { label: 'Surveillances', type: 'categorie', code:'UTI1S' },
  ...
  selectMainMenu(menu: string) {
      ...
      this.megaMenuItems = [
        {
          ...
          items: [
            [
              {
                label: 'Utilisateurs', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Groupes', type: 'fonction', code: 'GESAPR' }, { label: 'Rôles', type: 'fonction', code: 'UTLSR' }, { label: 'Profils de sécurité', type: 'fonction', code: 'UTLSR' }
                ]
              },
              {
                label: 'Licences', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Détail des licences', type: 'fonction', code: 'UTLSR' }, { label: 'Badges', type: 'fonction', code: 'UTLSR' }, { label: 'Téléchargement Licence', type: 'fonction', code: 'UTLSR' }
                ]
              },
              {
                label: 'Services Web', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Services xeb Classic SOAP', type: 'fonction', code: 'UTLSR' }, { label: 'Configuration pools Classic SOAP', type: 'fonction', code: 'UTLSR' },
                  { label: 'Services web REST', type: 'fonction', code: 'UTLSR' }
                ]
              },
            ],
            [
              {
                label: 'Paramétrages', type: 'categorie',
                items: [
                  { label: 'Paramètres généraux', type: 'fonction', code: 'UTLSR' }, { label: 'Paramètres régionaux', type: 'fonction', code: 'UTLSR' },
                  { label: 'Politiques de mot de passe', type: 'fonction', code: 'UTLSR' },
                  { label: 'Règles URL externes', type: 'fonction', code: 'UTLSR' }, { label: 'Configuration des proxy', type: 'fonction', code: 'UTLSR' }
                ]
              },
              {
                label: 'Authentification', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Serveurs LDAP', type: 'fonction', code: 'UTLSR' }, { label: 'Serveurs OAuth2', type: 'fonction', code: 'UTLSR' },
                  { label: 'Fournisseurs ID SAML2', type: 'fonction', code: 'UTLSR' },
                  { label: 'Applications connectées', type: 'fonction', code: 'UTLSR' }
                ]
              },
              {
                label: 'Certificats', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Certificats', type: 'fonction', code: 'UTLSR' }, { label: 'Certificats des Autorités de certification', type: 'fonction', code: 'UTLSR' }
                ]
              },
            ],
            [
              {
                label: 'Points de connexion', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Applications', type: 'fonction', code: 'UTLSR' }, { label: 'Solutions X3', type: 'fonction', code: 'UTLSR' },
                  { label: 'Points de connexion', type: 'fonction', code: 'UTLSR' }, { label: 'Serveur batch', type: 'fonction', code: 'UTLSR' }
                ]
              },
              {
                label: 'Serveurs', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Serveur web', type: 'fonction', code: 'UTLSR' }, { label: 'Serveurs de notification', type: 'fonction', code: 'UTLSR' },
                  { label: 'Serveurs BI', type: 'fonction', code: 'UTLSR' }, { label: 'Profils BI', type: 'fonction', code: 'UTLSR' }
                ]
              },
              {
                label: 'Portail Sage X3 People', type: 'categorie', code: 'UTLSR',
                items: [
                  { label: 'Serveurs', type: 'fonction', code: 'UTLSR' }, { label: 'Sites', type: 'fonction', code: 'UTLSR' }
                ]
              }
            ],
            // ... une deuxième rangée si nécessaire
          ]
        },
        {
          ...
          items: [
            [
              {
                items: [
                  { label: 'Equipes', type: 'fonction' },
                ]
              },
              {
                label: 'Documents', type: 'categorie',
                items: [
                  { label: 'Documents', type: 'fonction' }, { label: 'Modèles de documents Word', type: 'fonction' }, { label: 'Étiquettes de documents', type: 'fonction' },
                  { label: 'Catégories d\'étiquettes de documents', type: 'fonction' }
                ]
              },
              {
                label: 'Notification', type: 'categorie',
                items: [
                  { label: 'Événements de notification', type: 'fonction' }, { label: 'Modèles de notification', type: 'fonction' }, { label: 'Thèmes de notification', type: 'fonction' },

                ]
              },
              {
                items: [
                  { label: 'Volumes de stockage', type: 'fonction' },
                ]
              }
            ],
            // ... autres éléments de la liste si nécessaire
          ]
        },
        {
          ...
          items: [
            [
              {
                label: 'Pages', type: 'categorie',
                items: [
                  { label: 'Pages de navigation', type: 'fonction' }, { label: 'Pages d\'accueil', type: 'fonction' }, { label: 'Entrées de menu', type: 'fonction' },
                  { label: 'Sous-modules de menu', type: 'fonction' }, { label: 'Modules de menu', type: 'fonction' }, { label: 'Catégories de menu', type: 'fonction' }
                ]
              },
              {
                items: [
                  { label: 'Pages personnalisées', type: 'fonction' },
                ]
              },
              {
                label: 'Mobile', type: 'categorie',
                items: [
                  { label: 'Applications mobiles', type: 'fonction' }, { label: 'Portails mobiles', type: 'fonction' }, { label: 'Gadgets mobiles', type: 'fonction' },
                  { label: 'Tableau de bord d\'accueil mobile', type: 'fonction' }, { label: 'Migrer portail mobile', type: 'fonction' }
                ]
              }
            ],
            // ... autres éléments de la liste si nécessaire
        ...
        },
        {
          ...
          items: [
            [
              {
                label: 'Exports', type: 'categorie',
                items: [
                  { label: 'Profils d\'export', type: 'fonction' }, { label: 'Export des personnalisations', type: 'fonction' }, { label: 'Groupes de ressources', type: 'fonction' }
                ]
              },
              {
                label: 'Mise à jour', type: 'categorie',
                items: [
                  { label: 'À propos', type: 'fonction' }, { label: 'Mises à jour', type: 'fonction' }
                ]
              },
              {
                label: 'Imports', type: 'categorie',
                items: [
                  { label: 'Import de données', type: 'fonction' }, { label: 'Import des utilisateurs X3', type: 'fonction' }, { label: 'Import du profil menu', type: 'fonction' },
                  { label: 'Sessions d\'import', type: 'fonction' }
                ]
              },
              {
                label: 'Installation', type: 'categorie',
                items: [
                  { label: 'Installer les addins pour Office', type: 'fonction' }, { label: 'Installer l\'addin pour Outlook', type: 'fonction' }, { label: 'Connecteur Ilog', type: 'fonction' },
                  { label: 'Crystal Report Connector', type: 'fonction' }
                ]
              }
            ]
          ]
        },
        {
          ...
          items: [
            [
              {
                items: [{ label: 'Gestion du moteur de recherche', type: 'fonction' }]
              },
              {
                label: 'Gestion des sessions', type: 'categorie',
                items: [
                  { label: 'Suivi licence', type: 'fonction' }, { label: 'Informations de session', type: 'fonction' }
                ]
              },
              {
                label: 'Traces', type: 'categorie',
                items: [
                  { label: 'Traces de sessions X3', type: 'fonction' }
                ]
              },
              {
                label: 'Automatiser', type: 'categorie',
                items: [
                  { label: 'Ordonnanceur', type: 'fonction' }, { label: 'Traces serveur', type: 'fonction' }
                ]
              }
            ]
          ]
        ...
        // ... ajoutez plus de MegaMenuItem ici pour les autres sous-menus
      ];
    } else if (menu === 'Développement') {
      this.showUtilitairesSubMenu = true;
      ...
      this.megaMenuItems = [
        {
          ...
          items: [
            [
              ...
              {
                label: 'Fuseaux horaires', type: 'categorie',
                items: [
                  { label: 'Fuseaux horaires', type: 'fonction' }, 
                  { label: 'Règles d\'ajustement de l\'heure d\'été', type: 'fonction'},
                   { label: 'Transition heure d\'été', type: 'fonction' },//MISSING CODE
                ]
              },
            ],
          ]
        ...
        },
        {
          ...
          items: [
            [
              ...
              {
                items: [
                  { label: 'Temps hors production', type: 'fonction' },
                ]
              },
              {
                items: [
                  { label: 'Collaborateurs', type: 'fonction' },//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Equipes', type: 'fonction', code: 'GESTEM' },
                ]
              },
              {
                items: [
        ...
        },
        {
          ...
          items: [
            [
              ...
              {
                items: [
                  { label: 'Délai transport', type: 'fonction' },//MISSING CODE
                ]
              },
            ],
            [
              ...
              {
                items: [
                  { label: 'Conteneur frêt', type: 'fonction'},//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Modèle suivi logistique', type: 'fonction' },//MISSING CODE
                ]
              },
            ],
            [
              ...
              {
                items: [
                  { label: 'Lieu', type: 'fonction' },//MISSING CODE
                ]
              },
            ]
          ]
        ...
        },
        {
          ...
          items: [
            [
              {
                items: [
                  { label: 'Motifs économiques', type: 'fonction' , code: 'ECMLINK'},
                ]
              },
              {
                items: [
                  { label: 'Motifs économiques/Groupe de tiers', type: 'fonction'}, //MISSING CODE
                ]
              },
              {
                items: [
        ...
        },
        {
          ...
          items: [
            [
              ...
              {
                items: [
                  { label: 'Bâtiments', type: 'fonction'},//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Emplacements', type: 'fonction' },//MISSING CODE
                ]
              }
            ]]
        },
        ...
        },
        {
          ...
          items: [
            ...
            [
              {
                items: [
                  { label: 'Nomenclatures commerciales', type: 'fonction' , code: 'ECMLINK'},
                ]
              },
              {
                items: [
                  { label: 'Nomenclatures multi niveaux', type: 'fonction', code: 'GESBODC' },
                ]
              },
              {
        ...
        },
        {
          ...
          items: [
            [
              ...
              {
                items: [
                  { label: 'Structure suivi financier', type: 'fonction' },//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Requêtes suivi financier', type: 'fonction'},//MISSING CODE
                ]
              },
            ]
          ]
    ...
    else if (menu === 'Gestion des indices') {
      this.megaMenuItems = [
        {
          ...
          items: [
            [
              {
                items: [
                  { label: 'Demande de changement', type: 'fonction' },//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Analyse des impacts', type: 'fonction'},//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Planifier', type: 'fonction' },//MISSING CODE
                ]
              },
              {
                items: [
                  { label: 'Actions', type: 'fonction' },//MISSING CODE
                ]
              },
            ]
          ]
    ...
    else if (menu === 'Contrôle de gestion') {
      this.megaMenuItems = [
        {
    ...
    else if (menu === 'Comptabilité tiers') {
      this.megaMenuItems = [
        {
          label: 'Facturation',
          items: [
        ...
        },
        {
          ...
          items: [
            [
              {
                items: [
                  { label: 'Eléments physiques', type: 'fonction' }//MISSING CODE
                ]
              },
              {
                label: 'Traitements',
    ...
    else if (menu === 'Terminaux portables') {
      this.megaMenuItems = [
        {
          label: 'Terminaux portables',
          items: [
        ...
        },
        {
          ...
          items: [
            [
              {
                items: [
                  { label: 'Espace de stockage X3', type: 'fonction' },//MISSING CODE
                ]
              },
              {
                items: [
    ...
    else if (menu === 'Pages en lecture seule') {
      this.megaMenuItems = [
        {
          label: 'Comptabilité',
          items: [
    ...
    else if (menu === '4CAD Gestion de la qualité') {
      this.megaMenuItems = [
        {
    ...
    else if (menu === '4CAD Gestion des moyens') {
      this.megaMenuItems = [
        {
          label: 'Maintenance',
          items: [
    ...
    else if (menu === '4CAD Gestion des habilitations') {
      this.megaMenuItems = [
        {
          label: 'Habilitations',
          items: [
    ...
    else if (menu === '4CAD Devis technique') {
      this.megaMenuItems = [
        {
          label: 'Devis technique',
          items: [
    ...
    else if (menu === '4CAD Suivi atelier') {
      this.megaMenuItems = [
        {
          label: 'Paramétrage',
          items: [
